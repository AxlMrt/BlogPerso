...
export default function ErrorHandling({
	...
	return (
		<div className='w-full h-full flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 dark:bg-gray-900'>
			<div className='w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center'>
				...
				>
					...
					{btn === 'login' ? 'Se connecter' : "Retour à l'accueil"}
				</Link>
			</div>
